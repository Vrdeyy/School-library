...
<div class="flex min-h-screen items-center justify-center p-4">
    <div class="relative overflow-hidden bg-slate-50 border border-slate-300 shadow-xl rounded-[4mm] flex flex-col print:shadow-none print:border" 
        ...
        <div class="absolute inset-0 z-0 pointer-events-none overflow-hidden text-slate-900">
            ...
            <!-- Decorative Dots -->
            <div class="absolute top-[25mm] left-[45%] w-16 h-8 opacity-20" 
            ...
            <div class="absolute -bottom-6 -left-6 w-20 h-20 border-4 border-slate-200 rounded-full"></div>
        </div>
        ...
        <div class="relative z-10 px-5 pt-3 flex justify-between items-start">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center p-1.5">
        ...
        <div class="relative z-10 px-5 pt-4 flex flex-1 gap-4">
            ...
            <div class="flex-1">
                <div class="mb-4">
                    <h2 class="text-[5mm] font-extrabold uppercase text-slate-900 leading-tight" 
                    ...
                    <div class="inline-flex mt-2 bg-white border-2 border-slate-900 rounded-lg overflow-hidden shadow-[3px_3px_0px_#2563eb]">
                        ...
                        <span class="px-3 py-0.5 text-[2.2mm] font-bold text-slate-900">{{ $user->nis ?? $user->id }}</span>
                    </div>
                </div>
