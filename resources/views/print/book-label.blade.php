...
<div class="flex min-h-screen items-center justify-center bg-slate-100 p-4 print:bg-white print:p-0 print-container">
    <div class="relative overflow-hidden bg-white panel-border rounded-[2mm] flex flex-col print:shadow-none print:border-4" 
