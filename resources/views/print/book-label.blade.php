...
<div class="flex min-h-screen items-center justify-center bg-slate-100 p-4 print:bg-white print:p-0 font-['Outfit']">
    <div class="relative overflow-hidden bg-slate-50 border-2 border-slate-900 shadow-2xl rounded-[4mm] flex flex-col print:shadow-none print:border-4" 
